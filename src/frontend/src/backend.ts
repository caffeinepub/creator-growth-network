...
export class Backend implements backendInterface {
    ...
    async runCreatorSimulation(arg0: CreatorSimulationInput): Promise<CreatorSimulationOutput> {
        if (this.processError) {
            try {
                const result = await this.actor.runCreatorSimulation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async runInvestorSimulation(arg0: InvestorSimulationInput): Promise<InvestorSimulationOutput> {
        if (this.processError) {
            try {
                const result = await this.actor.runInvestorSimulation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
